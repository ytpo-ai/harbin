...
- Plan（仍在使用/推进）：
  ...
  - `docs/plan/ORCHESTRATION_TASK_ADDTASK_ASSIGNEE_AND_SUBTASK_PLAN.md`
...
| [ORCHESTRATION_CREATE_PLAN_PRECISE_SKILL_ACTIVATION_PLAN](../plan/ORCHESTRATION_CREATE_PLAN_PRECISE_SKILL_ACTIVATION_PLAN.MD) | [ORCHESTRATION_TASK_REQ-002_CREATE_PLAN_PRECISE_SKILL_ACTIVATION](../requirement/ORCHESTRATION_TASK_REQ-002_CREATE_PLAN_PRECISE_SKILL_ACTIVATION.md) | [待创建](../development/ORCHESTRATION_TASK_REQ-002_DEVELOPMENT.md) | — |
| [ORCHESTRATION_PLAN_PROJECT_SCOPED_AGENT_CONSTRAINT_PLAN](../plan/ORCHESTRATION_PLAN_PROJECT_SCOPED_AGENT_CONSTRAINT_PLAN.md) | [ORCHESTRATION_PLAN_REQ-001_PROJECT_SCOPED_AGENT](../requirement/ORCHESTRATION_PLAN_REQ-001_PROJECT_SCOPED_AGENT.md) | [待创建](../development/ORCHESTRATION_PLAN_REQ-001_DEVELOPMENT.md) | — |
| [ORCHESTRATION_TASK_ADDTASK_ASSIGNEE_AND_SUBTASK_PLAN](../plan/ORCHESTRATION_TASK_ADDTASK_ASSIGNEE_AND_SUBTASK_PLAN.md) | [REQ-003 追加任务指定执行者](../requirement/ORCHESTRATION_TASK_REQ-003_ADDTASK_ASSIGNEE.md) | [待创建](../development/ORCHESTRATION_TASK_REQ-003_DEVELOPMENT.md) | — |
| 同上 | [REQ-004 补充任务（子任务）支持](../requirement/ORCHESTRATION_TASK_REQ-004_SUBTASK_SUPPORT.md) | [待创建](../development/ORCHESTRATION_TASK_REQ-004_DEVELOPMENT.md) | — |
| [ORCHESTRATION_SUBTASK_PARENT_ROUTER_INHERIT_PLAN](../plan/ORCHESTRATION_SUBTASK_PARENT_ROUTER_INHERIT_PLAN.MD) | [ORCHESTRATION_TASK_REQ-005_SUBTASK_PARENT_ROUTER_INHERIT](../requirement/ORCHESTRATION_TASK_REQ-005_SUBTASK_PARENT_ROUTER_INHERIT.md) | [待创建](../development/ORCHESTRATION_TASK_REQ-005_DEVELOPMENT.md) | — |
