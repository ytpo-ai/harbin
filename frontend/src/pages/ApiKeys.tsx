...
const PROVIDERS = [
  ...
  { id: 'moonshotai', name: 'Kimi (Moonshot)', color: '#6366f1', category: 'LLM' },
  { id: 'xai', name: 'xAI (Grok)', color: '#1d1d1f', category: 'LLM' },
  { id: 'minimax', name: 'MiniMax', color: '#f59e0b', category: 'LLM' },
  { id: 'zhipuai', name: 'Zhipu AI', color: '#3b82f6', category: 'LLM' },
