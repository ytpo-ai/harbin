...
const LEGACY_TOOL_ID_ALIASES: Record<string, string> = {
  ...
  'mcp.orchestration.reassignTask': 'builtin.sys-mg.mcp.orchestration.reassign-task',
  'mcp.orchestration.completeHumanTask': 'builtin.sys-mg.mcp.orchestration.complete-human-task',
  'mcp.orchestration.createSchedule': 'builtin.sys-mg.mcp.orchestration.create-schedule',
  'mcp.orchestration.updateSchedule': 'builtin.sys-mg.mcp.orchestration.update-schedule',
  'mcp.orchestration.debugTask': 'builtin.sys-mg.mcp.orchestration.debug-task',
