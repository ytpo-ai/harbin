...
import { VIRTUAL_TOOL_IDS } from './builtin-tool-definitions';
...
const TOOL_IDS_TO_PURGE_ON_SYNC = [
  ...
  'builtin.sys-mg.internal.agent.list',
  ...
  'builtin.sys-mg.internal.agent-role.create',
  'builtin.sys-mg.internal.agent-role.delete',
  'builtin.sys-mg.internal.agent-role.list',
  'builtin.sys-mg.internal.agent-role.update',
  'builtin.sys-mg.internal.agent-memory.create',
  'builtin.sys-mg.internal.agent-memory.list',
  'builtin.sys-mg.internal.memory.append-memo',
  'builtin.sys-mg.internal.memory.search-memo',
  'builtin.sys-mg.internal.memory.create',
  'builtin.sys-mg.internal.memory.list',
  ...
  'builtin.sys-mg.internal.rd-related.repo-writer',
  'builtin.sys-mg.internal.docs.write',
  'builtin.sys-mg.internal.repo.write',
  'builtin.sys-mg.internal.rd-related.updates-read',
  'builtin.sys-mg.internal.tool-meta.get-tool-schema',
  'builtin.sys-mg.internal.tool-schema.get',
  ...
  'builtin.sys-mg.mcp.model.create',
  'builtin.sys-mg.mcp.model.list',
  ...
  'builtin.sys-mg.mcp.prompt-registry.save-template',
  'builtin.sys-mg.mcp.rd-intelligence.docs-heat-run',
  'builtin.sys-mg.mcp.rd-intelligence.engineering-statistics-run',
  'builtin.sys-mg.internal.commit.list',
  'builtin.sys-mg.internal.docs.read',
  'builtin.sys-mg.internal.repo.read',
  'builtin.sys-mg.mcp.docs-heat.run',
  'builtin.sys-mg.mcp.engineering-statistics.run',
  'builtin.sys-mg.mcp.skill-master.create-skill',
  'builtin.sys-mg.mcp.skill-master.list-skills',
  'builtin.sys-mg.mcp.skill.create',
  'builtin.sys-mg.mcp.skill.list',
...
export class ToolRegistryService {
  ...
  private async initializeBuiltinTools(mode: 'sync' | 'append' = 'sync') {
    ...
    if (mode === 'sync') {
      ...
      await this.toolModel.deleteMany({ id: { $in: TOOL_IDS_TO_PURGE_ON_SYNC } }).exec();
    }
