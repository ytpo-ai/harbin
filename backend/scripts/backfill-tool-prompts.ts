...
const TOOL_PROMPT_PRESETS: Record<string, string> = {
  ...
  'builtin.sys-mg.internal.memory.search-memo': '在处理任务时，优先调用 builtin.sys-mg.internal.memory.search-memo 检索相关历史备忘录。',
  'builtin.sys-mg.internal.memory.append-memo':
    '当形成关键结论或后续动作时，调用 builtin.sys-mg.internal.memory.append-memo 将知识、行为或TODO追加到备忘录。',
};
